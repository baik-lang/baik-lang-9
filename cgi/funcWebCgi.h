           ...
           Error("POST_NAMA: masukan data salah");
            ...
            if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 6 && valdat.array_i != '\0') {
                ...
                strcpy(datx.str, web_name[ get_int_array(valdat,idx) ]);
                datx.datatype = 3;
              } else {
                Error("POST_NAMA: masukan data salah");
              }
           ...
           Error("POST_NILAI: masukan data salah");
            ...
            if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 6 && valdat.array_i != '\0') {
                ...
                strcpy(datx.str, web_value[ get_int_array(valdat,idx) ]);
                datx.datatype = 3;
              } else {
                Error("POST_NILAI: masukan data salah");
              }
