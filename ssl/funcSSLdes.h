...
VAL_LABEL funcSSL_des_encrypt ()
{
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
           ...
           if(datx.datatype == 3) {
             ...
             Error("enkripsi_des: masukan data salah");
           }
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	encrypt_des(plaintext, (char *) &ciphertext, mykey);
...
VAL_LABEL funcSSL_des_decrypt ()
{
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
		   ...
		   if(datx.datatype == 3) {
             ...
             Error("dekripsi_des: masukan data salah");
           }
	} else if(lex.type == TYPE_STR) {
      if(n == 0) {
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	decrypt_des((char *) &plaintext, ciphertext, mykey);
