...
VAL_LABEL funcSSL_rc4_encrypt ()
{
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
           ...
           if(datx.datatype == 3) {
             ...
             Error("enkripsi_rc4: masukan data salah");
           }
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	encrypt_rc4(plaintext, (char *) &ciphertext, mykey);
...
VAL_LABEL funcSSL_rc4_decrypt ()
{
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
		   ...
		   if(datx.datatype == 3) {
             ...
             Error("dekripsi_rc4: masukan data salah");
           }
	} else if(lex.type == TYPE_STR) {
      if(n == 0) {
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	decrypt_rc4((char *)&plaintext, ciphertext, mykey);
