...
VAL_LABEL funcSSL_aes128ecb_encrypt ()
{
  VAL_LABEL datx;
  VAL_LABEL valdat;
  int n=0;
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
           ...
           if(datx.datatype == 3) {
             ...
             Error("enkripsi_aes128ecb: masukan data salah");
           }
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	encrypt_aes128ecb(plaintext, (char *) &ciphertext, mykey);
...
VAL_LABEL funcSSL_aes128ecb_decrypt ()
{
  VAL_LABEL datx;
  VAL_LABEL valdat;
  int n=0;
  ...
  do {
    ...
    if(lex.type == TYPE_IDENT) {
		   ...
		   if(datx.datatype == 3) {
             ...
             Error("dekripsi_aes128ecb: masukan data salah");
           }
	} else if(lex.type == TYPE_STR) {
      if(n == 0) {
  ...
  if(n == 2) {
    ...
    memset(&datx, '\0', sizeof(datx));
	decrypt_aes128ecb((char *)&plaintext, ciphertext, mykey);
