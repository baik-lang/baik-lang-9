...
void Do_AksiFungsi(GtkWidget *widget, gpointer data) {
  ...
  if(data == NULL) {
    ...
    // printf("----------- Aksi Fungsi \n");
	  ...
	  dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_fungsi"); // GTK3
...
void Do_AksiFungsiPressMouse(GtkWidget *widget, GdkEventButton *event, gpointer data) {
  ...
  if(data == NULL) {
    ...
    //printf("----------- Aksi Fungsi Press Mouse \n");

	dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_tekan_penunjuk"); // GTK3
...
void Do_AksiFungsiReleaseMouse(GtkWidget *widget, GdkEventButton *event, gpointer data) {
	...
	if (data == NULL) {
		...
		//printf("----------- Aksi Fungsi Release Mouse \n");

		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_lepas_penunjuk"); // GTK3
...
void Do_AksiFungsiMoveMouse(GtkWidget *widget, GdkEventButton *event, gpointer data) {
	...
	if (data == NULL) {
		...
		//printf("----------- Aksi Fungsi Move Mouse \n");

		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_penunjuk_bergerak"); // GTK3
...
void Do_AksiFungsiPressKeyboard(GtkWidget *widget, GdkEventKey *event, gpointer data) {
  ...
  if(data == NULL) {
    ...
    //printf("----------- Aksi Fungsi Press Keyboard \n");

    dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_presskeyboard");  // GTK3
...
void Do_AksiFungsiReleaseKeyboard(GtkWidget *widget, GdkEventKey *event, gpointer data) {
	...
	if (data == NULL) {
		...
		//printf("----------- Aksi Fungsi Release Keyboard \n");

		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_releasekeyboard");  // GTK3
...
// ///////////////////////////////////////////////////////////////////////////////////
// Aksi Fungsi Draw ( Old : Aksi Fungsi Ekspos)
// ///////////////////////////////////////////////////////////////////////////////////
gboolean Do_AksiFungsiDraw(GtkWidget *widget, cairo_t *cr, gpointer data) {
  ...
  if(data == NULL) {
	...
	dat = g_object_get_data(G_OBJECT(data), "cairo_aksi_ekspos"); // GTK3
...
// ///////////////////////////////////////////////////////////////////////////////////
void Do_AksiFungsiAtur(GtkWidget *widget, GdkEventConfigure *event, gpointer data) {
  ...
  if(data == NULL) {
	...
	dat = g_object_get_data(G_OBJECT(data), "cairo_aksi_atur"); // GTK3
...
void Do_AksiBendaFungsiPressKeyboard(GtkWidget *widget, GdkEventKey *event, gpointer data) {
...
void Do_AksiBendaFungsiReleaseKeyboard(GtkWidget *widget, GdkEventKey *event, gpointer data) {
...
void win_rambu_info(GtkWidget *widget, gpointer data)
{
	...
	if (data != NULL) {
		//printf("- get data from Object\n");
		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_info");  // GTK3
	}
	else {
...
void win_rambu_error(GtkWidget *widget, gpointer data)
{
	...
	if (data != NULL) {
		//printf("- get data from Object\n");
		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_error"); // GTK3
	}
	else {
		//printf("- get data from Global\n");
		dat = (PopupData *)malloc(sizeof(PopupData));
...
void win_rambu_warning(GtkWidget *widget, gpointer data)
{
	...
	if (data != NULL) {
		//printf("- get data from Object\n");
		dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_warn"); // GTK3
	}
	else {
		//printf("- get data from Global\n");
		dat = (PopupData *)malloc(sizeof(PopupData));
...
void win_lencana_jatidiri(GtkWidget *widget, gpointer data)
{
  GtkWidget      *dialog=NULL;
  ...
  if(data != NULL) {
    // printf("- get data from Object\n");
    dat = g_object_get_data(G_OBJECT(data), "lbl_aksi_jatidiri");  // GTK3
  } else {
  ...
  gtk_about_dialog_set_program_name(about,    dat->name);
