...
// Set warna huruf to komponen GUI dgn GTK3

#include <gdk/gdk.h>

void keySetWarnaDasar ()
{
	    ...
	    case TYPE_IDENT:
              ...
              if(valdat.datatype == 3) {
                ...
                if(n == 0) {
				  ...
				  //printf("SetWarnaDasar : get GUI type %d\n", valdat.GUItype);
