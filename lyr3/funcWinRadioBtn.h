...
VAL_LABEL funcWinRadioBtn ()
{
  ...
  n = 0;
    ...
    if(n == 1) {
     ...
     // printf("no grup\n");
     datx.widget  =  gtk_radio_button_new_with_label(NULL,tmpMsg0);
     ...
     if(! strcmp(tmpMsg0, "NULL")) {
       // printf("no grup\n");
       datx.widget  =  gtk_radio_button_new_with_label(NULL, tmpMsg);
	 } else {
       // printf("with grup\n");
       datx.widget  =  gtk_radio_button_new_with_label((GSList*)tmpdat.widget, tmpMsg);
	 }
