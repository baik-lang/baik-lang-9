...
void keyTitelLayar ()
{
  ...
  n = 0;
    ...
    if(n != 2) {
      ...
      //gtk_window_set_title(GTK_WINDOW(tmpdat.widget), g_locale_to_utf8(tmpMsg, -1,NULL,NULL,NULL));
      gtk_window_set_title(GTK_WINDOW(tmpdat.widget), tmpMsg);
      //gtk_window_set_title(tmpdat.widget, tmpMsg);
    }
