...
VAL_LABEL funcWinTeksKertas ()
{
  ...
  // printf("enter teks_masukan\n");
	  ...
	  switch( lex.type )
	    ...
	    case TYPE_IDENT:
              ...
              if(valdat.datatype == 40) {
                ...
                Error("bentuk perintah teks_kertas salah");
			  }
     ...
     // printf("start make teks kertas\n");
     // make grup tombol radio
     
	  if(tmpdat.GUItype == 12) {  // Kertas
          buffer = NULL;
        ...
        Error("Salah parameter untuk Teks_Kertas");
	  }

	 datx.datatype = 41;   // special string
	 return datx;
