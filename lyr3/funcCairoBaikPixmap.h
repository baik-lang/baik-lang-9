  ...
  memset(&class_tmpvar, '\0', sizeof(class_tmpvar));
      ...
      if(n!=4) {
		...
		if(tmpdat.datatype == 40) {
                  ...
                  datx.cr_surface = gdk_window_create_similar_surface (gtk_widget_get_window (tmpdat.widget),
                           CAIRO_CONTENT_COLOR,
                           gtk_widget_get_allocated_width (tmpdat.widget),
                           gtk_widget_get_allocated_height (tmpdat.widget));
