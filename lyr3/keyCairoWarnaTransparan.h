  ...
  memset(&class_tmpvar, '\0', sizeof(class_tmpvar));
        ...
        do {
           ...
           if(lex.type == TYPE_NUM) {
             ...
             if(n == 4)
              alpha  =lex.detail.dblnum;
           } else if(lex.type == TYPE_STR) {
			   Error("Warna_Transparan : masukan data salah");
             ...
             if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 6) {
                if(valdat.array_i == '\0')
                  Error("Warna_Transparan: ukuran Untaian belum terdefinisi");
                ...
                if(n == 4)
                  alpha = (double)get_int_array(valdat, idx);
                ...
                if(n == 4)
                  alpha = get_dbl_array(valdat, idx);
        ...
        if(n!=5) {
	      ...
	      cairo_set_source_rgba(cr_img, dat_num, dat_num2, dat_num3, alpha);
