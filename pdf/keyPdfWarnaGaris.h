  ...
  n = 0;
	  ...
	  switch( lex.type )
	    ...
	    case TYPE_IDENT:
              ...
              if(valdat.datatype == 71) {
                ...
                Error("bentuk perintah pdf_warnagaris salah");
			  }
	...
	if(n!=2) {
      ...
      if( ! strcmp(tmpMsg, "MERAH") || ! strcmp(tmpMsg, "merah") )
         HPDF_Page_SetRGBStroke (ppage, 1.0, 0.0, 0.0);
      if( ! strcmp(tmpMsg, "HIJAU") || ! strcmp(tmpMsg, "hijau") )
         HPDF_Page_SetRGBStroke (ppage, 0.0, 1.0, 0.0);
      if( ! strcmp(tmpMsg, "BIRU") || ! strcmp(tmpMsg, "biru") )
         HPDF_Page_SetRGBStroke (ppage, 0.0, 0.0, 1.0);
      if( ! strcmp(tmpMsg, "HITAM") || ! strcmp(tmpMsg, "hitam") )
         HPDF_Page_SetRGBStroke (ppage, 0.0, 0.0, 0.0);
      if( ! strcmp(tmpMsg, "PUTIH") || ! strcmp(tmpMsg, "putih") )
         HPDF_Page_SetRGBStroke (ppage, 1.0, 1.0, 1.0);
