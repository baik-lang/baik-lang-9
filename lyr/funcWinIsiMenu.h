...
VAL_LABEL funcWinIsiMenu ()
{
  ...
  n = 0;
		   ...
		   if(n == 0)
            ...
            if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 8) {
                ...
                Error("ISI_MENU: masukan data salah");
              }
           }
	...
	if(n == 1) {
		 // simple item
		 datx.widget   = gtk_image_menu_item_new_with_label(g_locale_to_utf8(tmpMsg, -1,NULL,NULL,NULL));
		 datx.isGUI    = 1;
		 datx.GUItype  = 10;   // MenuItem - IsiMenu - see ValLabel
