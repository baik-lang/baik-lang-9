	...
	do{
     ...
     memset(&mindat, '\0', sizeof(mindat));
	  ...
	  switch( lex.type )
	    ...
	    case TYPE_STR:
             Error("lukis_kotakisi: masukan data salah");
	      break;   
	    ...
	    case TYPE_IDENT:
              ...
              if(valdat.datatype == 80) { // cairo img
                ...
                Error("bentuk perintah lukis_kotakisi salah");
			  }

	      break;

        case TYPE_ARRAY:
              /* printf("KotakIsi get array\n"); */
