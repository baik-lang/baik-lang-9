  ...
  memset(&class_tmpvar, '\0', sizeof(class_tmpvar));
        ...
        do {
           ...
           if(lex.type == TYPE_NUM) {
             ...
             Error("Warna_Pena: masukan data salah");
             ...
             if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 6) {
                if(valdat.array_i == '\0')
                  Error("Warna_Pena: ukuran Untaian belum terdefinisi");
        ...
        if(n!=4) {
	      ...
	      cairo_set_source_rgb(cr_img, dat_num, dat_num2, dat_num3);
