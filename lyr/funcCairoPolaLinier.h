...
VAL_LABEL funcCairoPolaLinier () 
{
  VAL_LABEL datx;
  VAL_LABEL valdat, tmpdat;
  VAL_LABEL mindat; 

  double  dat_num=0.0, dat_num1=0.0, dat_num2=0.0, dat_num3=0.0;
  int  n=0, i=0;
  ...
  memset(&class_tmpvar, '\0', sizeof(class_tmpvar));
      ...
      do {
         ...
         if(lex.type == TYPE_NUM) {
             ...
             Error("PolaLinier: masukan data salah");
             ...
             if(strlen(lex.detail.array_str) > 0) {
              ...
              if(valdat.datatype == 6 ) {
                if(valdat.array_i == '\0')
                  Error("PolaLinier: ukuran Untaian belum terdefinisi");
      ...
      if(n!=4) {
          ...
          datx.cr_pattern = cairo_pattern_create_linear (dat_num, dat_num1, dat_num2, dat_num3);
		  datx.datatype = 82;
      }
