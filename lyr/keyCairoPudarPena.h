  ...
  // printf("keyCairoTebalGaris\n");
	do{
	  ...
	  switch( lex.type )
	    ...
	    case TYPE_STR:
             Error("transparasi_pena: masukan data salah");
	      break;   
	    ...
	    case TYPE_IDENT:
             ...
             if(currentClass != NULL && strlen(currentClass) > 0) {
              ...
              if(valdat.datatype == 80) { // cairo img
                ...
                Error("bentuk perintah transparasi_pena salah");
			  }
	...
	if(n!=2) {
      Error("bentuk perintah pudar_pena salah");
	} else {
	  // fade out - pemudaran warna
